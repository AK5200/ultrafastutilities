  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        {/* Hero */}
        <section className="bg-gradient-to-br from-slate-900 via-red-950 to-slate-900 text-white py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <nav className="flex items-center gap-2 text-slate-400 text-sm mb-6">
              <Link href="/" className="hover:text-white transition-colors">Home</Link>
              <ChevronRight className="w-4 h-4" />
              <span className="text-slate-200">Privacy Policy Fines and Penalties</span>
            </nav>
            <div className="flex items-center gap-3 mb-4">
              <DollarSign className="w-8 h-8 text-red-400" />
              <span className="text-red-400 font-semibold text-sm uppercase tracking-wide">Enforcement Guide</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Privacy Policy Fines and Penalties: What Regulators Can Actually Charge You
            </h1>
        ...
        <div className="border-b bg-slate-50 py-3 px-4">
          <div className="max-w-5xl mx-auto flex flex-wrap items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>Reviewed by compliance specialists</span>
            </div>
            <div className="flex items-center gap-2">
              <FileText className="w-4 h-4 text-blue-600" />
              <span>Covers GDPR, CCPA, FTC, and Australian law</span>
            </div>
            <div className="flex items-center gap-2">
