        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-slate-400 text-sm mb-4">
              ...
              <span>Privacy Policy for Beehiiv</span>
            </div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold">
                  Privacy Policy for Beehiiv Newsletter Creators
                </h1>
                <p className="text-slate-400 mt-1">Beehiiv Privacy Requirements 2026</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 mt-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-1"><FileText className="w-4 h-4" />12 min read</span>
            </div>
          </div>
        </section>
        ...
        <section className="border-b bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-600">
              ...
              <div className="flex items-center gap-2"><Globe className="w-4 h-4 text-blue-600" /><span>GDPR and CAN-SPAM coverage</span></div>
              <div className="flex items-center gap-2"><Users className="w-4 h-4 text-purple-600" /><span>Used by 20,000+ newsletter creators</span></div>
              <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-600" /><span>Beehiiv-specific guidance</span></div>
            </div>
          </div>
        </section>
