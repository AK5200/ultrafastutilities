        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-slate-400 text-sm mb-4">
              ...
              <span>Privacy Policy for Podcast</span>
            </div>
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-purple-500/20 p-3 rounded-xl"><Mic className="w-8 h-8 text-purple-400" /></div>
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold">Privacy Policy for a Podcast</h1>
                <p className="text-slate-400 mt-1">Podcaster Privacy Guide 2026</p>
              </div>
            </div>
            <p className="text-xl text-slate-300 max-w-2xl">Your podcast website, email list, and hosting platform all collect listener data. Here is what your privacy policy must cover and why it matters.</p>
        ...
        <section className="border-b bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-600">
              ...
              <div className="flex items-center gap-2"><Globe className="w-4 h-4 text-blue-600" /><span>GDPR and CCPA compliant</span></div>
              <div className="flex items-center gap-2"><Users className="w-4 h-4 text-purple-600" /><span>Used by 20,000+ podcasters</span></div>
            </div>
          </div>
        </section>
