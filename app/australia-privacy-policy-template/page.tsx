        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-slate-400 text-sm mb-4">
              ...
              <span>Australia Privacy Policy Template</span>
            </div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-400 mt-1">
                  Privacy Act 1988 Compliance Guide 2026
                </p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Privacy Act 1988 and APPs compliant</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-purple-600" />
                <span>Used by 20,000+ Australian businesses</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span>NDB scheme guidance included</span>
              </div>
            </div>
          </div>
        </section>
