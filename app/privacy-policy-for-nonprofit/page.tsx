        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-slate-400 text-sm mb-4">
              ...
              <span>Privacy Policy for Nonprofit</span>
            </div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold">
                  Privacy Policy for Nonprofit Organizations
                </h1>
                <p className="text-slate-400 mt-1">Nonprofit Privacy Requirements 2026</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 mt-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-1"><FileText className="w-4 h-4" />14 min read</span>
            </div>
          </div>
        </section>
        ...
        <section className="border-b bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-600">
              <div className="flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-green-600" /><span>Reviewed by nonprofit attorneys</span></div>
              <div className="flex items-center gap-2"><Globe className="w-4 h-4 text-blue-600" /><span>GDPR and US state law coverage</span></div>
              <div className="flex items-center gap-2"><Users className="w-4 h-4 text-purple-600" /><span>Used by 5,000+ nonprofits</span></div>
              <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-600" /><span>Donor and beneficiary guidance</span></div>
            </div>
          </div>
        </section>
